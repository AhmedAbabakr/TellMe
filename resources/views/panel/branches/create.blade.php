                ...
                <div class="col-lg-12">
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('branch.store')}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('POST')
                                 @if(auth()->user()->company === null)
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('branch_name')) is-valid @endif" id="namee" name="branch_name" value="{{old('branch_name')}}" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required number form-control @if ($errors->has('branch_code')) is-valid @endif"  name="branch_code" value="{{old('branch_code')}}">
