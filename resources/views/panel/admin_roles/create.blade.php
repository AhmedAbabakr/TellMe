                  ...
                  <div class="col-lg-12">
                      ...
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Add Admin Type</li>
                          </ol>
                      </nav>
                      <!--breadcrumbs end -->
                  </div>
                ...
                <div class="col-lg-12">
                      <section class="card">
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('admin_roles.store')}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('POST')
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Type Name</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('admin_type_name')) is-valid @endif" id="namee" name="admin_type_name" value="{{old('admin_type_name')}}" >
                                          ...
                                          <div class="col-sm-10">
                                              <select class="required number form-control @if ($errors->has('admin_type_is_active')) is-valid @endif" name="admin_type_is_active" >
                                                 <option  value="" disabled="disabled" selected="">Select Status</option>
                                                            ...
                                                            @if(old('admin_type_is_active') == 1)

                                                               {{"selected"}}
                                                            @endif >Active</option>
                                                            <option value="0" 
                                                            
                                                            @if(old('admin_type_is_active') == 0)
                                          ...
                                          <div class="col-sm-10">
                                              <select class="required number form-control @if ($errors->has('admin_type_enable_to_company')) is-valid @endif" name="admin_type_enable_to_company" >
                                                 <option  value="" disabled="disabled" selected="">Select Status</option>
                                                            ...
                                                            @if(old('admin_type_enable_to_company') === 1)

                                                               {{"selected"}}
                                                            @endif >Enable</option>
                                                            <option value="0" 
                                                            
                                                            @if(old('admin_type_enable_to_company') === 0)
