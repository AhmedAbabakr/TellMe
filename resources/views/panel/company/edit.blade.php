                 ...
                 @if(Session::has('success'))
                  ...
                  @endif
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('company.update',encrypt($company->company_id))}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('PUT')
                                   <div class="form-group">
                                      <label class="col-sm-2 control-label">Company English Name</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('company_name_en')) is-valid @endif"  name="company_name_en" value="{{$company->company_name_en}}" >
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('company_name_ar')) is-valid @endif"  name="company_name_ar" value="{{$company->company_name_ar}}" >
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <div id="cp5b" class="input-group colorpicker-component colorpicker-element" title="Using format option" data-colorpicker-id="7">
                                              <input type="text" class="required form-control input-lg" name="company_color" value="{{$company->company_color}}">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                      @if($company->company_background === null)
                                                          <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" />
                                                      @else
                                                          <img src="{{asset($company->company_background)}}" alt="" />
                                                      @endif
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control ckeditor" name="company_address_en" rows="6">{{$company->company_address_en}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label col-sm-2">Company Address Arabic (Optional)</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control ckeditor" name="company_address_ar" rows="6">{{$company->company_address_ar}}</textarea>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                      <label class="col-sm-2 control-label">Mobile Number (Optional)</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="number form-control @if ($errors->has('company_phone')) is-valid @endif"  name="company_phone" value="{{$company->company_phone}}">
