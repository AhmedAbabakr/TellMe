                 ...
                 @if(Session::has('success'))
                  ...
                  @endif
                         <div class="card-body">
                              ...
                              <form class="form-horizontal tasi-form" method="POST" action="{{route('users.update',encrypt($user->admin_id))}}" enctype="multipart/form-data" id="commentForm">
                                 @csrf()
                                 @method('PUT')
                                      ...
                                      <div class="col-sm-10">
                                          <select class="required number form-control @if ($errors->has('company_id')) is-valid @endif" name="company_id" >
                                             <option  value="" disabled="disabled" selected="">Select Company</option>
                                                        ...
                                                        @if($user->company->company_id == $company->company_id)
                                 ...
                                 <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <select class="required number form-control @if ($errors->has('admin_type')) is-valid @endif" name="admin_type" >
                                             <option  value="" disabled="disabled" selected="">Select Type</option>
                                                        ...
                                                        @if($user->admin_type == $type->admin_type_id)
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('admin_name')) is-valid @endif" id="namee" name="admin_name" value="{{$user->admin_name}}" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="required form-control @if ($errors->has('admin_username')) is-valid @endif"  name="admin_username" value="{{$user->admin_username}}">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control @if ($errors->has('admin_email')) is-valid @endif"  name="admin_email" value="{{$user->admin_email}}">
